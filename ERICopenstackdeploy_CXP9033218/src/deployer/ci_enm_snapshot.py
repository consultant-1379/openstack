"""This file contains logic for CI ENM snapshot deployment."""
...
class CIENMSnapshotDeployment(Command):
    """
    ENM snapshot deployment.
    ...
    def __init__(self, *args, **kwargs):
        """Initialize a CIENMSnapshot Deployment Command object."""
    ...
    def get_parser(self, prog_name):
        ...
        Arguments:
            prog_name (str): deployer ci enm snapshot deployment

        Returns:
            parser (object): list parameters for 'deployer ci enm snapshot deployment --help'
            usage: deployer ci enm snapshot deployment [-h] --deployment-name [DEPLOYMENT_NAME]
    ...
    def take_action(self, args):
        ...
        lcm_ip_address = (vnf_lcm_sed_object.sed_data['parameter_defaults']
        ...
        if life_cycle_manager.is_ha_deployment:
            lcm_ip_address = (vnf_lcm_sed_object.sed_data['parameter_defaults']
        ...
        workflow.wait_for_workflow_definition(
            workflow_id=f'enmdeploymentworkflows.--.{workflows_version}.--.SnapshotDeployment__top'
        )
        workflow.execute_workflow_and_wait(
            workflow_name='Snapshot Deployment',
            workflow_id=f'enmdeploymentworkflows.--.{workflows_version}.--.SnapshotDeployment__top',
        ...
        LOG.info(
            'The Snapshot Deployment workflow has successfully completed. Now follow the relevant \

"""This file contains logic relating to CI VIO Platform Upgrade."""
...
class CIVIOPlatformUpgrade(Command):
    """
    Upgrades VIO Platform with the help of CI tools including DIT.
    ...
    def __init__(self, *args, **kwargs):
        """Initialize a CIVIOPlatformUpgrade Command object."""
    ...
    def get_parser(self, prog_name):
        ...
        Arguments:
            prog_name (str): deployer ci vio platform upgrade

        Returns:
            parser (object): list parameters for 'deployer ci vio platform upgrade --help'
            usage: deployer ci vio platform upgrade [-h] --deployment-name [DEPLOYMENT_NAME]
    ...
    def take_action(self, args):
        ...
        dvms.configure_dvms_for_platform(profile=CONFIG.get('vio', 'upgrade_init_dvms'))
        ...
        dvms.run_profile(
            profile=CONFIG.get('vio', 'sienm_upgrade')
        )
        dvms.run_profile(
            profile=CONFIG.get('vio', 'sienm_upgrade_dryrun')
        )
        dvms.run_profile(
        ...
        LOG.info(
            'The Small Integrated ENM platform upgrade has successfully completed. \
